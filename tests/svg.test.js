const fs = require("fs");
const foldDraw = require("../fold-draw");

test("invalid json", () => {
  try {
    foldDraw.svg("{\"key\": invalid json}");
...
test("boundary points", () => {
  fs.readFile("./tests/examples/single-vertex.fold", (err, data) => {
    ...
    const boundaries = foldDraw.components.svg.boundaries(singleVertex);
    ...
    // const frame0 = foldDraw.svg(singleVertex);
    // const frame1 = foldDraw.svg(singleVertex, { frame: 1, shadows: true, padding: 0.1 });
